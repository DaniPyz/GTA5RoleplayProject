...
export default function Createchar() {
	...
	function randomCharacter() {
		...
		setClothes([func.random(0, 3), func.random(0, 3), func.random(0, 3)]);
	}
				...
				<section className="createchar-body">
						...
						{listNames.map((item, i) => {
							return (
								<div
									...
									className={list === i ? "createchar-body-list-select" : ""}
								>
									<img src={item.img} />
									<span>{item.name}</span>
								</div>
					...
					<section className="createchar-body-top">
						<section className="createchar-body-top-wrap" style={list !== 0 ? { display: "none" } : {}}>
							<div className="createchar-body-input">
								...
								<input
									...
									onInput={(e) => {
										let nameTemp = [...name];
										nameTemp[0] = e.target.value.trim().replace(" ", "");
										setName(nameTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input">
								...
								<input
									...
									onInput={(e) => {
										let nameTemp = [...name];
										nameTemp[1] = e.target.value.trim().replace(" ", "");
										setName(nameTemp);
									}}
								/>
							</div>
								...
								<section>
									<div>
										<input
											...
											type="radio"
											id="createchar-radio-gender-male"
											name="createchar-radio-gender"
									...
									<div>
										<input
											className="input-radio"
											type="radio"
											id="createchar-radio-gender-female"
											name="createchar-radio-gender"
						...
						<section className="createchar-body-top-wrap" style={list !== 1 ? { display: "none" } : {}}>
								...
								<section>
									<div>
										<input
											className="input-radio"
											type="radio"
											id="createchar-radio-parents-mother"
											name="createchar-radio-parents"
											checked={parents === 0 ? true : false}
											onClick={() => setParents(0)}
										/>
									...
									<div>
										<input
											className="input-radio"
											type="radio"
											id="createchar-radio-parents-father"
											name="createchar-radio-parents"
											checked={parents === 1 ? true : false}
											onClick={() => setParents(1)}
										/>
							...
							<div className="createchar-body-list-choice" style={parents === 1 ? { display: "none" } : {}}>
								{parentsList[0].map((item, i) => {
									return (
										<img
											onClick={() => setGenetic({ ...genetic, mother: item.id })}
											key={i}
											className={genetic.mother === item.id ? "createchar-body-list-choice-select" : ""}
											src={item.img}
										/>
									);
								})}
							...
							<div className="createchar-body-list-choice" style={parents === 0 ? { display: "none" } : {}}>
								{parentsList[1].map((item, i) => {
									return (
										<img
											onClick={() => setGenetic({ ...genetic, father: item.id })}
											key={i}
											className={genetic.father === item.id ? "createchar-body-list-choice-select" : ""}
											src={item.img}
										/>
									);
								})}
							...
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									min="0.1"
									step="0.1"
									value={genetic.similarity}
									onChange={(e) => setGenetic({ ...genetic, similarity: parseFloat(e.target.value) })}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								<span>
								...
								<input
									...
									min="0.1"
									step="0.1"
									value={genetic.skinTone}
									onChange={(e) => setGenetic({ ...genetic, skinTone: parseFloat(e.target.value) })}
								/>
							</div>
						</section>
						...
						<section className="createchar-body-top-wrap" style={list !== 2 ? { display: "none" } : {}}>
							...
							<div className="createchar-body-list-choice">
								{hairsList[gender].map((item, i) => {
									return (
										<img
											onClick={() => setHair({ ...hair, head: item.id })}
											key={i}
											className={hair.head === item.id ? "createchar-body-list-choice-select" : ""}
											src={item.img}
										/>
									);
								})}
							...
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									step="1"
									value={hair.beard}
									onChange={(e) => setHair({ ...hair, beard: parseInt(e.target.value) })}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								<span>
								...
								<input
									...
									step="1"
									value={hair.eyebrow}
									onChange={(e) => setHair({ ...hair, eyebrow: parseInt(e.target.value) })}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								<span>
								...
								<input
									...
									step="1"
									value={hair.breast}
									onChange={(e) => setHair({ ...hair, breast: parseInt(e.target.value) })}
								/>
							</div>
						</section>
							...
							<div className="createchar-body-input createchar-body-input-choice createchar-body-input-color">
								...
								<section>
									{hairColorList.map((item, i) => {
										return (
											<div
												onClick={() => setHair({ ...hair, head_color: item.id })}
												className={hair.head_color === item.id && "createchar-body-input-color-sel"}
							...
							<div className="createchar-body-input createchar-body-input-choice createchar-body-input-color">
								...
								<section>
									{hairColorList.map((item, i) => {
										return (
											<div
												onClick={() => setHair({ ...hair, beard_color: item.id })}
												className={hair.beard_color === item.id && "createchar-body-input-color-sel"}
												style={{ "background-color": item.color }}
											></div>
										);
									})}
							...
							<div className="createchar-body-input createchar-body-input-choice createchar-body-input-color">
								...
								<section>
									{hairColorList.map((item, i) => {
										return (
											<div
												onClick={() => setHair({ ...hair, eyebrow_color: item.id })}
												className={hair.eyebrow_color === item.id && "createchar-body-input-color-sel"}
												style={{ "background-color": item.color }}
											></div>
										);
									})}
							...
							<div className="createchar-body-input createchar-body-input-choice createchar-body-input-color">
								...
								<section>
									{hairColorList.map((item, i) => {
										return (
											<div
												onClick={() => setHair({ ...hair, breast_color: item.id })}
												className={hair.breast_color === item.id && "createchar-body-input-color-sel"}
												style={{ "background-color": item.color }}
											></div>
										);
									})}
						...
						<section className="createchar-body-top-wrap" style={list !== 4 ? { display: "none" } : {}}>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									value={appearance[0]}
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[0] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[1] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[2] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[3] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[4] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[5] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[6] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[7] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
							<div className="createchar-body-input createchar-body-input-flex">
								...
								<input
									...
									onChange={(e) => {
										let appearanceTemp = [...appearance];
										appearanceTemp[8] = parseInt(e.target.value);
										setAppearance(appearanceTemp);
									}}
								/>
							</div>
						...
						<section className="createchar-body-top-wrap" style={list !== 5 ? { display: "none" } : {}}>
							{face.map((item, i) => {
								return (
									<div key={i} className="createchar-body-input">
										...
										<input
											...
											onChange={(e) => {
												let faceTemp = [...face];
												faceTemp[i] = parseFloat(e.target.value);
												setFace(faceTemp);
											}}
										/>
									</div>
						...
						<section className="createchar-body-top-wrap" style={list !== 6 ? { display: "none" } : {}}>
							{clothes.map((item, i) => {
								return (
									<div key={i} className="createchar-body-input createchar-body-input-choice">
										<span>{i === 0 ? "Верх" : i === 1 ? "Низ" : "Обувь"}</span>
										<section>
											<Choiceinput
												data={{
													select: clothes[i],
													params: clothesList[i],
													onChange: (value) => {
														let clothesTemp = [...clothes];
														clothesTemp[i] = value;
