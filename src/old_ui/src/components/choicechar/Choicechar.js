		...
		<div className="choicechar" style={!toggle ? { display: "none" } : {}}>
			...
			<section className="choicechar-body">
				{chars.map((item, i) => {
					if (item.id) {
						return (
							<div key={i} className="choicechar-body-elem">
								...
								<section className="choicechar-body-elem-btn">
									<button className="btn" onClick={() => selectChar(i)}>
										Выбрать
									</button>
								</section>
							</div>
						...
						return (
							<div key={i} className="choicechar-body-elem choicechar-body-elem-buy">
								<section className="choicechar-body-elem-title">
									<h1>Платный слот</h1>
									<span></span>
								</section>
								<section className="choicechar-body-elem-desc">Данный слот можно разблокировать за 650 York Coins</section>
								<section className="choicechar-body-elem-btn">
									<button className="btn btn-select" onClick={() => selectChar(i)}>
										Разблокировать
									</button>
								</section>
							</div>
						...
						return (
							<div key={i} className="choicechar-body-elem choicechar-body-elem-buy choicechar-body-elem-free">
								<section className="choicechar-body-elem-title">
									<h1>Свободный слот</h1>
								</section>
								<section className="choicechar-body-elem-desc">Вы можете создать своего персонажа в данном слоту</section>
								<section className="choicechar-body-elem-btn">
									<button className="btn btn-select" onClick={() => selectChar(i)}>
										Создать персонажа
									</button>
