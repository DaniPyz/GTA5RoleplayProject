...
//     if (tempInv[indexInSection] && tempInv[indexInSection].id === id && count > 0) {
...
//       }
//       else {
//         count -= tempInv[indexInSection].count
//         tempInv[indexInSection] = 0
//       }
//       container.clear('user', player.id, 'char_inventory')
//       container.set('user', player.id, 'char_inventory', tempInv)
//     } else {
...
//       if (tempInv[indexInSection] && tempInv[indexInSection].id === id && count > 0) {
//         console.log('RemovedItemBackpack', container.get('user', player.id, 'char_backpack'), count, indexInSection)
...
//           tempInv[indexInSection] = 0
//         }
//         container.clear('user', player.id, 'char_backpack')
//         container.set('user', player.id, 'char_backpack', tempInv)
